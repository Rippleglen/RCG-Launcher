...
function parseModulesForUI(mdls, submodules, servConf){
    ...
    for(const mdl of mdls){
        ...
        if(mdl.rawModule.type === Type.ForgeMod || mdl.rawModule.type === Type.LiteMod || mdl.rawModule.type === Type.LiteLoader || mdl.rawModule.type === Type.FabricMod || mdl.rawModule.type === Type.QuiltMod){
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/Rippleglen/RCG-Launcher/releases.atom',
        success: (data) => {
