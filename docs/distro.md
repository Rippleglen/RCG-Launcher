...
The most up to date and accurate descriptions of the distribution spec can be viewed in [ripplelauncher-distribution-types](https://github.com/dscalzi/ripplelauncher-distribution-types).
